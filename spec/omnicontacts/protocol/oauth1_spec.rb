...
describe OmniContacts::OAuth1 do 
  ...
  before(:all) do
    ...
    class OAuth1TestClass 
      include OmniContacts::OAuth1
    end
    @test_target = OAuth1TestClass.new("consumer_key", "consumer_secret", "auth_host", "request_token_path", "auth_path", "access_token_path", "callback")
  end
